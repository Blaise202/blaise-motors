              ...
              <form class="p-4" action="{{ url('AddNewCar') }}" method="POST">
                ...
                <div class="row mt-5 inp-bright">
                  ...
                  <div class="col-12 col-sm-6 py-2 wow fadeInRight ">
                    ...
                    <textarea placeholder="..." style="color:#b5b0b2;" class="form-control" style="height: 100px;" name="job_description"></textarea>
                  </div>
                  <div class="col-12 col-sm-6 py-2 wow fadeInRight ">
                    <label>Qualifications</label>
                    <textarea placeholder="..." style="color:#b5b0b2;" class="form-control" style="height: 100px;" name="qualification"></textarea>
                  </div>
                  ...
                  <div class="col-12 col-sm-4 py-2 wow fadeInRight">
                    ...
                    <input placeholder="..." style="color:#b5b0b2;" type="date" class="form-control"
                      name="deadlines">
                  </div>
                  <div class="col-12 col-sm-4 py-2 wow fadeInRight">
                    <label>Opportunities</label>
                    <input placeholder="..." style="color:#b5b0b2;" type="text" name="opportunities"
                      class="form-control">
                  </div>
                  <div class="col-12 col-sm-4 py-2 wow fadeInRight">
                    <label>Contact</label>
